...
def assignment_3():
    ...
    def get_inflation_values_for_year(year, number_of_values):
        ...
        return pd.concat(
            [highest_inflation_values, lowest_inflation_values]
        ).sort_values()
...
def assignemnt_5():
    ...
    def plot_inflation_for_country(country, country_code, subject, frequency, measure):
        ...
        # List of colors to plot the circles with
        colors = [
            "salmon",
            "red",
            "blue",
        ...
        for i in range(max_min_values.shape[0]):
            ...
            inflation_value = max_min_values.values[i][1]
            value_type = "Minsta"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        choice = input("Välj vilken Assignment du vill köra: ")
        # This only works in Python >= 3.10, but I expect that to be fine since that
        # version was released 2021
        match choice:
            case "1":
                assignment_2_a()
